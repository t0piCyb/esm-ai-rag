      ...
      <main className="relative py-24 sm:py-32 lg:pb-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            >
              Powered by RAG technology, it answers any student question —
              without exposing your content.
            </Typography>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <ShimmerButton
                href="/signin"
                background="hsl(var(--primary))"
                className="rounded-md px-3.5 py-2.5 text-sm font-semibold text-muted-foreground hover:text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
              >
                Request a Demo
              </ShimmerButton>
              <Link
          ...
          <Image
            alt="AI answering training questions with reference to sources"
            src="/gif/demo-chat-with-sources.gif"
            width={1280}
            height={720}
